...
# You can change this to {'mask', 'cap'} or just {'mask', 'glove', 'cap'}
...
# YOLO Class Mapping (based on your data.yaml)
CLASS_NAMES = {
    0: 'mask',
    1: 'glove',
    2: 'cap'
...
MODEL_PATH = r"runs\detect\runs\detect\ppe_engine\weights\best.pt"

def main():
    print("==========================================")
    print(" YOLO PPE Engine - Compliance Arbiter")
    print("==========================================")
    ...
    while True:
        ...
        # 1. Run YOLO Inference (lowered confidence to 0.3)
